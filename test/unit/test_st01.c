...
void test_st01()
{
	...
	// TM[1,1]
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_1_createAcceptanceReportSuccess(&tm, apid.apid, pus_getNextPacketCount(&apid), &tc));
	...
	// TM[1,2]
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_2_createAcceptanceReportFailure(&tm, apid.apid, pus_getNextPacketCount(&apid), &tc, pus_ST01_ERROR_SERVICE_UNAVAILABLE, &info1));
	...
	// TM[1,3]
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_3_createStartReportSuccess(&tm, apid.apid, pus_getNextPacketCount(&apid), &tc));
	CU_ASSERT_EQUAL(PUS_NO_ERROR, PUS_EXPECT_ST01(&tm, pus_TM_1_3_successfulStart));

	// TM[1,4]
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_4_createStartReportFailure(&tm, apid.apid, pus_getNextPacketCount(&apid), &tc, pus_ST01_ERROR_WRONG_FORMAT, NULL));
	...
	// TM[1,5]
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_5_createProgressReportSuccess(&tm, apid.apid, pus_getNextPacketCount(&apid), &tc, 71));
	CU_ASSERT_EQUAL(PUS_NO_ERROR, PUS_EXPECT_ST01(&tm, pus_TM_1_5_successfulProgress));
	CU_ASSERT_EQUAL(71, pus_tm_1_X_getStep(&tm));

	// TM[1,6]
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_6_createProgressReportFailure(&tm, apid.apid, pus_getNextPacketCount(&apid), &tc, 72, pus_ST01_ERROR_SUBTYPE_UNAVAILABLE, NULL));
	...
	// TM[1,7]
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_7_createCompletionReportSuccess(&tm, apid.apid, pus_getNextPacketCount(&apid), &tc));
	CU_ASSERT_EQUAL(PUS_NO_ERROR, PUS_EXPECT_ST01(&tm, pus_TM_1_7_successfulCompletion));

	// TM[1,8]
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_8_createCompletionReportFailure(&tm, apid.apid, pus_getNextPacketCount(&apid), &tc, pus_ST01_ERROR_WRONG_FORMAT, NULL));
	...
	// Errors
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_X_createReport(NULL, apid.apid, apid.packetCount, &tc, 0));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());

	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_X_createReport(&tm, apid.apid, apid.packetCount, NULL, 0));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_1_createAcceptanceReportSuccess(NULL, apid.apid, apid.packetCount, &tc));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_1_createAcceptanceReportSuccess(&tm, apid.apid, apid.packetCount, NULL));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_2_createAcceptanceReportFailure(NULL, apid.apid, apid.packetCount, &tc, 1, &info1));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_2_createAcceptanceReportFailure(&tm, apid.apid, apid.packetCount, NULL, 1, &info1));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_3_createStartReportSuccess(NULL, apid.apid, apid.packetCount, &tc));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_3_createStartReportSuccess(&tm, apid.apid, apid.packetCount, NULL));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_4_createStartReportFailure(NULL, apid.apid, apid.packetCount, &tc, 1, &info1));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_4_createStartReportFailure(&tm, apid.apid, apid.packetCount, NULL, 1, &info1));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_5_createProgressReportSuccess(NULL, apid.apid, apid.packetCount, &tc, 11));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_5_createProgressReportSuccess(&tm, apid.apid, apid.packetCount, NULL, 13));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_6_createProgressReportFailure(NULL, apid.apid, apid.packetCount, &tc, 11, 1, &info1));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();;
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_6_createProgressReportFailure(&tm, apid.apid, apid.packetCount, NULL, 13, 1, &info1));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_7_createCompletionReportSuccess(NULL, apid.apid, apid.packetCount, &tc));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_7_createCompletionReportSuccess(&tm, apid.apid, apid.packetCount, NULL));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();

	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_8_createCompletionReportFailure(NULL, apid.apid, apid.packetCount, &tc, 1, &info1));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, pus_tm_1_8_createCompletionReportFailure(&tm, apid.apid, apid.packetCount, NULL, 1, &info1));
	CU_ASSERT_EQUAL(PUS_ERROR_NULLPTR, PUS_GET_ERROR());
	pus_clearError();
	...
	PUS_SET_ERROR(PUS_ERROR_NOT_IMPLEMENTED);
	CU_ASSERT_EQUAL(PUS_ERROR_BEFORE, pus_tm_1_3_createStartReportSuccess(&tm, apid.apid, apid.packetCount, &tc));
	PUS_SET_ERROR(PUS_ERROR_NOT_IMPLEMENTED);
	CU_ASSERT_EQUAL(PUS_ERROR_BEFORE, pus_tm_1_4_createStartReportFailure(&tm, apid.apid, apid.packetCount, &tc, 0, &info1));
	PUS_SET_ERROR(PUS_ERROR_NOT_IMPLEMENTED);
	CU_ASSERT_EQUAL(PUS_ERROR_BEFORE, pus_tm_1_5_createProgressReportSuccess(&tm, apid.apid, apid.packetCount, &tc, 20));
	PUS_SET_ERROR(PUS_ERROR_NOT_IMPLEMENTED);
	CU_ASSERT_EQUAL(PUS_ERROR_BEFORE, pus_tm_1_6_createProgressReportFailure(&tm, apid.apid, apid.packetCount, &tc, 21, 1, &info1));
	PUS_SET_ERROR(PUS_ERROR_NOT_IMPLEMENTED);
	...
	CU_ASSERT_EQUAL(PUS_ERROR_NOT_TC, pus_tm_1_1_createAcceptanceReportSuccess(&tm, apid.apid, apid.packetCount, &tm));
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NOT_TC, pus_tm_1_2_createAcceptanceReportFailure(&tm, apid.apid, apid.packetCount, &tm, 0, NULL));
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NOT_TC, pus_tm_1_3_createStartReportSuccess(&tm, apid.apid, apid.packetCount, &tm));
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NOT_TC, pus_tm_1_4_createStartReportFailure(&tm, apid.apid, apid.packetCount, &tm, 0, &info1));
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NOT_TC, pus_tm_1_5_createProgressReportSuccess(&tm, apid.apid, apid.packetCount, &tm, 20));
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NOT_TC, pus_tm_1_6_createProgressReportFailure(&tm, apid.apid, apid.packetCount, &tm, 21, 1, &info1));
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NOT_TC, pus_tm_1_7_createCompletionReportSuccess(&tm, apid.apid, apid.packetCount, &tm));
	pus_clearError();
	CU_ASSERT_EQUAL(PUS_ERROR_NOT_TC, pus_tm_1_8_createCompletionReportFailure(&tm, apid.apid, apid.packetCount, &tm, 1, &info1));
	pus_clearError();
	...
	CU_ASSERT_EQUAL(PUS_NO_ERROR, pus_tm_1_1_createAcceptanceReportSuccess(&tm, apid.apid, apid.packetCount, &tc));

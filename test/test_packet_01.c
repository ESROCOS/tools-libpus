...
void test_setPacketDefaults_null(void)
{
    pus_result_t res = pus_setPacketDefaults(NULL);
    
    CU_ASSERT(PUS_NULLPTR == res);
}
...
int main()
{
    ...
    if ((NULL == CU_add_test(pSuite, "test_setPacketDefaults_null", test_setPacketDefaults_null)) /*||
    ...
    return CU_get_number_of_suites_failed();
}

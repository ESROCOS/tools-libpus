...
PYBIND11_MODULE(pusbinding, m) {
	...
	py::class_<pusSt01packets_t>(m, "pusSt01packets_t")
		.def(py::init<>());
	...
	m.def("pus_st01_pushTmAceptanceReportIfNeeded", &pus_st01_pushTmAceptanceReportIfNeeded, "Binding for pus_st01_pushTmAceptanceReportIfNeeded");
	m.def("pus_st01_pushTmStartReportIfNeeded", &pus_st01_pushTmStartReportIfNeeded, "Binding for pus_st01_pushTmStartReportIfNeeded");
	m.def("pus_st01_pushTmProgressReportIfNeeded", &pus_st01_pushTmProgressReportIfNeeded, "Binding for pus_st01_pushTmProgressReportIfNeeded");
	m.def("pus_st01_pushTmCompletionReportIfNeeded", &pus_st01_pushTmCompletionReportIfNeeded, "Binding for pus_st01_pushTmCompletionReportIfNeeded");
	...
	py::class_<pusSt03packets_t>(m, "pusSt03packets_t")
		.def(py::init<>());
	...
	m.def("pus_events_getEventId", &pus_events_getEventId, "Binding for pus_events_getEventId");
	m.def("pus_events_setEventId", &pus_events_setEventId, "Binding for pus_events_setEventId");
	m.def("pus_events_getEventAuxData", &pus_events_getEventAuxData, "Binding for pus_events_getEventAuxData");
	m.def("pus_events_setEventAuxData", &pus_events_setEventAuxData, "Binding for pus_events_setEventAuxData");
	m.def("pus_events_getEventAuxData1", &pus_events_getEventAuxData1, "Binding for pus_events_getEventAuxData1");
	m.def("pus_events_setEventAuxData1", &pus_events_setEventAuxData1, "Binding for pus_events_setEventAuxData1");
	m.def("pus_events_getEventAuxData2", &pus_events_getEventAuxData2, "Binding for pus_events_getEventAuxData2");
	m.def("pus_events_setEventAuxData2", &pus_events_setEventAuxData2, "Binding for pus_events_setEventAuxData2");
	m.def("pus_expectSt05Tm", &pus_expectSt05Tm, "Binding for pus_expectSt05Tm");

	m.doc() = "pus_st08_packets binding";
	py::class_<pusSt08packets_t>(m, "pusSt08packets_t")
		.def(py::init<>());
	...
	py::class_<pusSt17packets_t>(m, "pusSt17packets_t")
		.def(py::init<>());
	...
	py::class_<pusSt19packets_t>(m, "pusSt19packets_t")
		.def(py::init<>());

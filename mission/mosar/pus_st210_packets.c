...
/* R_ICU_SPW_PNP */
pusError_t pus_tc_210_1_createSpwRoutingTableSetEntry(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusUInt16 setRoutingEntry, asn1SccPusUInt8 spwTrafficPriority)
{
	if (NULL == outTc)
	{
	...
	else
	{
		...
		pus_setTcSubtype(outTc, pus_TC_210_1_SpwRoutingTableSetEntry); //TODO

		pus_setTcDataKind(outTc, pus_TC_DATA_ST_210_1); // TODO pus_mission_types.h
...
pusError_t pus_tc_210_2_createSpwPnpSetOwnerFields(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusUInt16 setOwner)
{
	if (NULL == outTc)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	else
	{
		...
		// Service identification
		pus_setTcService(outTc, pus_ST210_rmapManagement);
		pus_setTcSubtype(outTc, pus_TC_210_2_SpwPnpSetOwnerFields); //TODO
...
/* R_ICU */
pusError_t pus_tc_210_11_createConfigureTimeEpoch(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusInt32 rIcuSecondsSinceEpoch, asn1SccPusInt32 rIcuNanosecondsSinceEpoch)
{
	if (NULL == outTc)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	else
	{
		...
		// Service identification
		pus_setTcService(outTc, pus_ST210_rmapManagement);
		pus_setTcSubtype(outTc, pus_TC_210_11_ConfigureTimeEpoch); //TODO

		pus_setTcDataKind(outTc, pus_TC_DATA_ST_210_1); // TODO pus_mission_types.h
		pus_tc_210_11_setParamSM_ID(outTc, smId);
		pus_tc_210_11_setParamRIcuSecondsSinceEpoch(outTc, rIcuSecondsSinceEpoch);
		pus_tc_210_11_setParamRIcuNanosecondsSinceEpoch(outTc, rIcuNanosecondsSinceEpoch);
...
asn1SccPusInt32 pus_tc_210_11_getParamRIcuSecondsSinceEpoch(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	return inTC->data.u.tcData.data.u.st_210_11.rIcuSecondsSinceEpoch; // TODO - check ASN1 names
}

pusError_t pus_tc_210_11_setParamRIcuSecondsSinceEpoch(pusPacket_t* outTC, asn1SccPusInt32 param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	outTC->data.u.tcData.data.u.st_210_11.rIcuSecondsSinceEpoch = param; // TODO - check ASN1 names
	return PUS_SET_ERROR(PUS_NO_ERROR);
}
asn1SccPusInt32 pus_tc_210_11_getParamRIcuNanosecondsSinceEpoch(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	return inTC->data.u.tcData.data.u.st_210_11.rIcuNanosecondsSinceEpoch; // TODO - check ASN1 names
}

pusError_t pus_tc_210_11_setParamRIcuNanosecondsSinceEpoch(pusPacket_t* outTC, asn1SccPusInt32 param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	outTC->data.u.tcData.data.u.st_210_11.rIcuNanosecondsSinceEpoch = param; // TODO - check ASN1 names
	return PUS_SET_ERROR(PUS_NO_ERROR);
}

pusError_t pus_tc_210_12_createSetLeds(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusUInt8 rIcuSetLeds)
{
	if (NULL == outTc)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	else
	{
		...
		// Service identification
		pus_setTcService(outTc, pus_ST210_rmapManagement);
		pus_setTcSubtype(outTc, pus_TC_210_12_SetLeds); //TODO

		pus_setTcDataKind(outTc, pus_TC_DATA_ST_210_1); // TODO pus_mission_types.h
		pus_tc_210_12_setParamSM_ID(outTc, smId);
		pus_tc_210_12_setParamRIcuSetLeds(outTc, rIcuSetLeds);
...
asn1SccPusUInt8 pus_tc_210_12_getParamRIcuSetLeds(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	return inTC->data.u.tcData.data.u.st_210_12.rIcuSetLeds; // TODO - check ASN1 names
}

pusError_t pus_tc_210_12_setParamRIcuSetLeds(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	outTC->data.u.tcData.data.u.st_210_12.rIcuSetLeds = param; // TODO - check ASN1 names
	return PUS_SET_ERROR(PUS_NO_ERROR);
}

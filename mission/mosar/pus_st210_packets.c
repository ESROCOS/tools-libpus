...
pusError_t pus_tc_210_62_createHk2Request(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusUInt8 componentId)
{
	if (NULL == outTc)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	else
	{
		...
		// Service identification
		pus_setTcService(outTc, pus_ST210_rmapManagement);
		pus_setTcSubtype(outTc, pus_TC_210_62_Hk2Request);
...
asn1SccPusUInt8 pus_tc_210_62_getParamSM_ID(const pusPacket_t* inTC)
{
	...
	if( PUS_NO_ERROR != PUS_EXPECT_ST210TC(inTC, pus_TC_210_62_Hk2Request))
	{
		return 0;
	}
	else
...
pusError_t pus_tc_210_62_setParamSM_ID(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	...
	if(PUS_NO_ERROR != PUS_EXPECT_ST210TC(outTC, pus_TC_210_62_Hk2Request))
	{
		return PUS_GET_ERROR();
	}
...
pusError_t pus_tc_210_63_createAllHkRequest(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusUInt8 componentId)
{
	if (NULL == outTc)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	else
	{
		...
		// Service identification
		pus_setTcService(outTc, pus_ST210_rmapManagement);
		pus_setTcSubtype(outTc, pus_TC_210_63_AllHkRequest);
...
asn1SccPusUInt8 pus_tc_210_63_getParamSM_ID(const pusPacket_t* inTC)
{
	...
	if( PUS_NO_ERROR != PUS_EXPECT_ST210TC(inTC, pus_TC_210_63_AllHkRequest))
	{
		return 0;
	}
	else
...
pusError_t pus_tc_210_63_setParamSM_ID(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	...
	if(PUS_NO_ERROR != PUS_EXPECT_ST210TC(outTC, pus_TC_210_63_AllHkRequest))
	{
		return PUS_GET_ERROR();
	}
...
pusError_t pus_tc_210_64_createGoToState(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusUInt8 componentId, asn1SccPusUInt8 targetState)
{
	if (NULL == outTc)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	else
	{
		...
		// Service identification
		pus_setTcService(outTc, pus_ST210_rmapManagement);
		pus_setTcSubtype(outTc, pus_TC_210_64_GoToState);
		...
		pus_tc_210_64_setParamTargetState(outTc, targetState);
...
asn1SccPusUInt8 pus_tc_210_64_getParamSM_ID(const pusPacket_t* inTC)
{
	...
	if( PUS_NO_ERROR != PUS_EXPECT_ST210TC(inTC, pus_TC_210_64_GoToState))
	{
		return 0;
	}
	else
...
pusError_t pus_tc_210_64_setParamSM_ID(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	...
	if(PUS_NO_ERROR != PUS_EXPECT_ST210TC(outTC, pus_TC_210_64_GoToState))
	{
		return PUS_GET_ERROR();
	}
...
asn1SccPusUInt8 pus_tc_210_64_getParamTargetState(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	return inTC->data.u.tcData.data.u.st_210_64.targetState;
}

pusError_t pus_tc_210_64_setParamTargetState(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	outTC->data.u.tcData.data.u.st_210_64.targetState = param;
	return PUS_SET_ERROR(PUS_NO_ERROR);
}

pusError_t pus_tc_210_65_createCommand48VConverter(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusUInt8 componentId, asn1SccPusBoolean conv48vCmd)
{
	if (NULL == outTc)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	else
	{
		...
		// Service identification
		pus_setTcService(outTc, pus_ST210_rmapManagement);
		pus_setTcSubtype(outTc, pus_TC_210_65_Command48vConverter);

		pus_setTcDataKind(outTc, pus_TC_DATA_ST_210_65);
		pus_tc_210_65_setParamSM_ID(outTc, smId);
		pus_tc_210_65_setParamCOMP_ID(outTc, componentId);
		pus_tc_210_65_setParamConv48vCmd(outTc, conv48vCmd);
...
asn1SccPusUInt8 pus_tc_210_65_getParamSM_ID(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	if( PUS_NO_ERROR != PUS_EXPECT_ST210TC(inTC, pus_TC_210_65_Command48vConverter))
	{
		return 0;
	}
	else
	...
	return inTC->data.u.tcData.data.u.st_210_65.smId;
}

pusError_t pus_tc_210_65_setParamSM_ID(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	}
	if(PUS_NO_ERROR != PUS_EXPECT_ST210TC(outTC, pus_TC_210_65_Command48vConverter))
	{
		return PUS_GET_ERROR();
	}
	
	outTC->data.u.tcData.data.u.st_210_65.smId = param;
	return PUS_SET_ERROR(PUS_NO_ERROR);
}

asn1SccPusUInt8 pus_tc_210_65_getParamCOMP_ID(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	return inTC->data.u.tcData.data.u.st_210_65.componentId;
}

pusError_t pus_tc_210_65_setParamCOMP_ID(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	outTC->data.u.tcData.data.u.st_210_65.componentId = param;
	return PUS_SET_ERROR(PUS_NO_ERROR);
}

asn1SccPusBoolean pus_tc_210_65_getParamConv48vCmd(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	return inTC->data.u.tcData.data.u.st_210_65.conv48vCmd;
}

pusError_t pus_tc_210_65_setParamConv48vCmd(pusPacket_t* outTC, asn1SccPusBoolean param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	outTC->data.u.tcData.data.u.st_210_65.conv48vCmd = param;
	return PUS_SET_ERROR(PUS_NO_ERROR);
}

pusError_t pus_tc_210_66_createCommandBatCharger(pusPacket_t* outTc, pusApid_t apid, pusSequenceCount_t sequenceCount, asn1SccPusUInt8 smId, asn1SccPusUInt8 componentId, asn1SccPusBoolean batChCmd)
{
	if (NULL == outTc)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	else
	{
		...
		// Service identification
		pus_setTcService(outTc, pus_ST210_rmapManagement);
		pus_setTcSubtype(outTc, pus_TC_210_66_CommandBatCharger);

		pus_setTcDataKind(outTc, pus_TC_DATA_ST_210_66);
		pus_tc_210_66_setParamSM_ID(outTc, smId);
		pus_tc_210_66_setParamCOMP_ID(outTc, componentId);
		pus_tc_210_66_setParamBatChCmd(outTc, batChCmd);
...
asn1SccPusUInt8 pus_tc_210_66_getParamSM_ID(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	if( PUS_NO_ERROR != PUS_EXPECT_ST210TC(inTC, pus_TC_210_66_CommandBatCharger))
	{
		return 0;
	}
	else
	...
	return inTC->data.u.tcData.data.u.st_210_66.smId;
}

pusError_t pus_tc_210_66_setParamSM_ID(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	}
	if(PUS_NO_ERROR != PUS_EXPECT_ST210TC(outTC, pus_TC_210_66_CommandBatCharger))
	{
		return PUS_GET_ERROR();
	}
	
	outTC->data.u.tcData.data.u.st_210_66.smId = param;
	return PUS_SET_ERROR(PUS_NO_ERROR);
}

asn1SccPusUInt8 pus_tc_210_66_getParamCOMP_ID(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	return inTC->data.u.tcData.data.u.st_210_66.componentId;
}

pusError_t pus_tc_210_66_setParamCOMP_ID(pusPacket_t* outTC, asn1SccPusUInt8 param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	outTC->data.u.tcData.data.u.st_210_66.componentId = param;
	return PUS_SET_ERROR(PUS_NO_ERROR);
}

asn1SccPusBoolean pus_tc_210_66_getParamBatChCmd(const pusPacket_t* inTC)
{
	if( NULL == inTC  )
	{
		PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	return inTC->data.u.tcData.data.u.st_210_66.batChCmd;
}

pusError_t pus_tc_210_66_setParamBatChCmd(pusPacket_t* outTC, asn1SccPusBoolean param)
{
	if(NULL == outTC)
	{
		return PUS_SET_ERROR(PUS_ERROR_NULLPTR);
	...
	outTC->data.u.tcData.data.u.st_210_66.batChCmd = param;
	return PUS_SET_ERROR(PUS_NO_ERROR);
}
...
pusError_t pus_expectSt210Tc(const pusPacket_t* packet, pusSubservice_t expectedSubtype, const char* function)
{
	...
	if (PUS_NO_ERROR == expectResult)
	{
		...
		if (expectedSubtype == pusSubtype_NONE)
		{
			// Check that subtype corresponds to ST[210]
		 	if (
			    ...
			    subtype != pus_TC_210_62_Hk2Request &&
			    subtype != pus_TC_210_63_AllHkRequest &&
			    subtype != pus_TC_210_64_GoToState &&
			    subtype != pus_TC_210_65_Command48vConverter &&
			    subtype != pus_TC_210_66_CommandBatCharger &&
        ...
        if (
			...
			kind != PusTcApplicationData_st_210_65_PRESENT &&
            kind != PusTcApplicationData_st_210_66_PRESENT &&

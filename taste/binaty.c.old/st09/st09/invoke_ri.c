...
void st09_RI_getApid(asn1SccPusApid *OUT_apid)
{
#ifdef __unix__
    ...
    if (1 == innerMsc) {
        ...
        printf ("\nINNER: st09,timereportapid,getApid,%lld\n", msc_time);
        fflush(stdout);
    }
#endif
    ...
    extern void vm_st09_getApid(void *, size_t *);

    vm_st09_getApid(OUT_buf_apid, &size_OUT_buf_apid);
...
void st09_RI_getSequenceCount(asn1SccPusSequenceCount *OUT_sequenceCount)
{
#ifdef __unix__
    static int innerMsc = -1;
    if (-1 == innerMsc)
    ...
    if (1 == innerMsc) {
        ...
        printf ("\nINNER: st09,timereportapid,getSequenceCount,%lld\n", msc_time);
        fflush(stdout);
    }
#endif
    ...
    /* Call to VM callback function */
    extern void vm_st09_getSequenceCount(void *, size_t *);

    vm_st09_getSequenceCount(OUT_buf_sequenceCount, &size_OUT_buf_sequenceCount);
...
void st09_RI_ACK(const asn1SccPusPacket *IN_tcPacket, const asn1SccPusSubserviceType *IN_reportType, const asn1SccPusSt01FailureCode *IN_error, const asn1SccPusSt01FailureInfo *IN_errorInfo, const asn1SccPusStepId *IN_step)
{
#ifdef __unix__
    static int innerMsc = -1;
    if (-1 == innerMsc)
...
#ifdef __unix__
        printf ("** Encoding error in st09_RI_ACK!!\n");
#endif
    ...
    /* Call to VM callback function */
    extern void vm_st09_ACK(void *, size_t, void *, size_t, void *, size_t, void *, size_t, void *, size_t);

    vm_st09_ACK(IN_buf_tcPacket, size_IN_buf_tcPacket, IN_buf_reportType, size_IN_buf_reportType, IN_buf_error, size_IN_buf_error, IN_buf_errorInfo, size_IN_buf_errorInfo, IN_buf_step, size_IN_buf_step);

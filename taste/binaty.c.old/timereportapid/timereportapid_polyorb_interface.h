...
#ifndef timereportapid_POLYORB_INTERFACE
#define timereportapid_POLYORB_INTERFACE
#include <stddef.h>
...
----------------------------------------------------*/
void sync_timereportapid_getApid(void *, size_t *);

/*----------------------------------------------------
-- Protected Provided Interface "getSequenceCount"
----------------------------------------------------*/
void sync_timereportapid_getSequenceCount(void *, size_t *);

...
void pusservices_initService12()
{
	pus_pmon_initialize(NULL);
}

void pusservices_processTc12(const asn1SccPusPacket *IN_tcPacket)
{
...
void pusservices_st12_PmonTrigger()
{

...
:${AUTOPROJ_CURRENT_ROOT}/install/include/pus/mission/test_01\
:${AUTOPROJ_CURRENT_ROOT}/install/include/pus/mission/test_01/mpy\
:/usr/include/python3.6m"


export X86_PARTITION_USER_LDFLAGS="-L$AUTOPROJ_CURRENT_ROOT/install/lib -lesrocos_pus_core_test_01 -lesrocos_pus_test_01 -lpython3.6m"

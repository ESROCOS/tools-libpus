...
void *myThreadFun(void* arg)
{
    ...
    */
    ...
    PyRun_SimpleString("builtins.ESROCOS_PUSGUI_MODULE = \"esrocos_pus_mosar\"\n");
    PyRun_SimpleString("builtins.ESROCOS_PUSGUI_CONFIG = \"/home/peraspera/esrocos_workspace/tools/libpus/mission/mosar/gui_config.json\"\n");
    PyRun_SimpleString("builtins.ESROCOS_PUSGUI_MISSION = \"/home/peraspera/esrocos_workspace/tools/libpus/mission/mosar\"\n");

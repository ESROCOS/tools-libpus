...
#ifdef __NEED_PusTC_3_5_Data_UPER
int Encode_UPER_PusTC_3_5_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_3_5_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_3_5_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-3-5-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_3_5_Data_ACN
int Encode_ACN_PusTC_3_5_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_3_5_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_3_5_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-3-5-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_3_5_Data_NATIVE
int Encode_NATIVE_PusTC_3_5_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_3_5_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_3_5_Data) );
    return sizeof(asn1SccPusTC_3_5_Data);
}
#endif

#ifdef __NEED_PusTC_3_5_Data_UPER
int Decode_UPER_PusTC_3_5_Data(asn1SccPusTC_3_5_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_3_5_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-3-5-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_3_5_Data_ACN
int Decode_ACN_PusTC_3_5_Data(asn1SccPusTC_3_5_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_3_5_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_3_5_Data_NATIVE
int Decode_NATIVE_PusTC_3_5_Data(asn1SccPusTC_3_5_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_3_5_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_3_6_Data_UPER
int Encode_UPER_PusTC_3_6_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_3_6_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_3_6_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-3-6-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_3_6_Data_ACN
int Encode_ACN_PusTC_3_6_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_3_6_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_3_6_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-3-6-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_3_6_Data_NATIVE
int Encode_NATIVE_PusTC_3_6_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_3_6_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_3_6_Data) );
    return sizeof(asn1SccPusTC_3_6_Data);
}
#endif

#ifdef __NEED_PusTC_3_6_Data_UPER
int Decode_UPER_PusTC_3_6_Data(asn1SccPusTC_3_6_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_3_6_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-3-6-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_3_6_Data_ACN
int Decode_ACN_PusTC_3_6_Data(asn1SccPusTC_3_6_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_3_6_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_3_6_Data_NATIVE
int Decode_NATIVE_PusTC_3_6_Data(asn1SccPusTC_3_6_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_3_6_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTM_200_18_Data_UPER
int Encode_UPER_PusTM_200_18_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTM_200_18_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTM_200_18_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTM-200-18-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTM_200_18_Data_ACN
int Encode_ACN_PusTM_200_18_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTM_200_18_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTM_200_18_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTM-200-18-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTM_200_18_Data_NATIVE
int Encode_NATIVE_PusTM_200_18_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTM_200_18_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTM_200_18_Data) );
    return sizeof(asn1SccPusTM_200_18_Data);
}
#endif

#ifdef __NEED_PusTM_200_18_Data_UPER
int Decode_UPER_PusTM_200_18_Data(asn1SccPusTM_200_18_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTM_200_18_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTM-200-18-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTM_200_18_Data_ACN
int Decode_ACN_PusTM_200_18_Data(asn1SccPusTM_200_18_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTM_200_18_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTM_200_18_Data_NATIVE
int Decode_NATIVE_PusTM_200_18_Data(asn1SccPusTM_200_18_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTM_200_18_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_200_19_Data_UPER
int Encode_UPER_PusTC_200_19_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_200_19_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_200_19_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-200-19-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_200_19_Data_ACN
int Encode_ACN_PusTC_200_19_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_200_19_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_200_19_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-200-19-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_200_19_Data_NATIVE
int Encode_NATIVE_PusTC_200_19_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_200_19_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_200_19_Data) );
    return sizeof(asn1SccPusTC_200_19_Data);
}
#endif

#ifdef __NEED_PusTC_200_19_Data_UPER
int Decode_UPER_PusTC_200_19_Data(asn1SccPusTC_200_19_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_200_19_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-200-19-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_200_19_Data_ACN
int Decode_ACN_PusTC_200_19_Data(asn1SccPusTC_200_19_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_200_19_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_200_19_Data_NATIVE
int Decode_NATIVE_PusTC_200_19_Data(asn1SccPusTC_200_19_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_200_19_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTM_200_20_Data_UPER
int Encode_UPER_PusTM_200_20_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTM_200_20_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTM_200_20_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTM-200-20-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTM_200_20_Data_ACN
int Encode_ACN_PusTM_200_20_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTM_200_20_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTM_200_20_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTM-200-20-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTM_200_20_Data_NATIVE
int Encode_NATIVE_PusTM_200_20_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTM_200_20_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTM_200_20_Data) );
    return sizeof(asn1SccPusTM_200_20_Data);
}
#endif

#ifdef __NEED_PusTM_200_20_Data_UPER
int Decode_UPER_PusTM_200_20_Data(asn1SccPusTM_200_20_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTM_200_20_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTM-200-20-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTM_200_20_Data_ACN
int Decode_ACN_PusTM_200_20_Data(asn1SccPusTM_200_20_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTM_200_20_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTM_200_20_Data_NATIVE
int Decode_NATIVE_PusTM_200_20_Data(asn1SccPusTM_200_20_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTM_200_20_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_200_1_Data_UPER
int Encode_UPER_PusTC_200_1_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_200_1_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_200_1_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-200-1-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_200_1_Data_ACN
int Encode_ACN_PusTC_200_1_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_200_1_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_200_1_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-200-1-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_200_1_Data_NATIVE
int Encode_NATIVE_PusTC_200_1_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_200_1_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_200_1_Data) );
    return sizeof(asn1SccPusTC_200_1_Data);
}
#endif

#ifdef __NEED_PusTC_200_1_Data_UPER
int Decode_UPER_PusTC_200_1_Data(asn1SccPusTC_200_1_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_200_1_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-200-1-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_200_1_Data_ACN
int Decode_ACN_PusTC_200_1_Data(asn1SccPusTC_200_1_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_200_1_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_200_1_Data_NATIVE
int Decode_NATIVE_PusTC_200_1_Data(asn1SccPusTC_200_1_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_200_1_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTM_200_16_Data_UPER
int Encode_UPER_PusTM_200_16_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTM_200_16_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTM_200_16_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTM-200-16-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTM_200_16_Data_ACN
int Encode_ACN_PusTM_200_16_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTM_200_16_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTM_200_16_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTM-200-16-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTM_200_16_Data_NATIVE
int Encode_NATIVE_PusTM_200_16_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTM_200_16_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTM_200_16_Data) );
    return sizeof(asn1SccPusTM_200_16_Data);
}
#endif

#ifdef __NEED_PusTM_200_16_Data_UPER
int Decode_UPER_PusTM_200_16_Data(asn1SccPusTM_200_16_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTM_200_16_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTM-200-16-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTM_200_16_Data_ACN
int Decode_ACN_PusTM_200_16_Data(asn1SccPusTM_200_16_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTM_200_16_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTM_200_16_Data_NATIVE
int Decode_NATIVE_PusTM_200_16_Data(asn1SccPusTM_200_16_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTM_200_16_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_WmstatusPred_UPER
int Encode_UPER_WmstatusPred(void *pBuffer, size_t iMaxBufferSize, const asn1SccWmstatusPred *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccWmstatusPred_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode WmstatusPred (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_WmstatusPred_ACN
int Encode_ACN_WmstatusPred(void *pBuffer, size_t iMaxBufferSize, asn1SccWmstatusPred *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccWmstatusPred_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode WmstatusPred (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_WmstatusPred_NATIVE
int Encode_NATIVE_WmstatusPred(void *pBuffer, size_t iMaxBufferSize, const asn1SccWmstatusPred *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccWmstatusPred) );
    return sizeof(asn1SccWmstatusPred);
}
#endif

#ifdef __NEED_WmstatusPred_UPER
int Decode_UPER_WmstatusPred(asn1SccWmstatusPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccWmstatusPred_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode WmstatusPred (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_WmstatusPred_ACN
int Decode_ACN_WmstatusPred(asn1SccWmstatusPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccWmstatusPred_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_WmstatusPred_NATIVE
int Decode_NATIVE_WmstatusPred(asn1SccWmstatusPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccWmstatusPred *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_SodmissionPred_UPER
int Encode_UPER_SodmissionPred(void *pBuffer, size_t iMaxBufferSize, const asn1SccSodmissionPred *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccSodmissionPred_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode SodmissionPred (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_SodmissionPred_ACN
int Encode_ACN_SodmissionPred(void *pBuffer, size_t iMaxBufferSize, asn1SccSodmissionPred *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccSodmissionPred_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode SodmissionPred (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_SodmissionPred_NATIVE
int Encode_NATIVE_SodmissionPred(void *pBuffer, size_t iMaxBufferSize, const asn1SccSodmissionPred *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccSodmissionPred) );
    return sizeof(asn1SccSodmissionPred);
}
#endif

#ifdef __NEED_SodmissionPred_UPER
int Decode_UPER_SodmissionPred(asn1SccSodmissionPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccSodmissionPred_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode SodmissionPred (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_SodmissionPred_ACN
int Decode_ACN_SodmissionPred(asn1SccSodmissionPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccSodmissionPred_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_SodmissionPred_NATIVE
int Decode_NATIVE_SodmissionPred(asn1SccSodmissionPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccSodmissionPred *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_SodplannerPred_UPER
int Encode_UPER_SodplannerPred(void *pBuffer, size_t iMaxBufferSize, const asn1SccSodplannerPred *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccSodplannerPred_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode SodplannerPred (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_SodplannerPred_ACN
int Encode_ACN_SodplannerPred(void *pBuffer, size_t iMaxBufferSize, asn1SccSodplannerPred *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccSodplannerPred_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode SodplannerPred (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_SodplannerPred_NATIVE
int Encode_NATIVE_SodplannerPred(void *pBuffer, size_t iMaxBufferSize, const asn1SccSodplannerPred *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccSodplannerPred) );
    return sizeof(asn1SccSodplannerPred);
}
#endif

#ifdef __NEED_SodplannerPred_UPER
int Decode_UPER_SodplannerPred(asn1SccSodplannerPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccSodplannerPred_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode SodplannerPred (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_SodplannerPred_ACN
int Decode_ACN_SodplannerPred(asn1SccSodplannerPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccSodplannerPred_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_SodplannerPred_NATIVE
int Decode_NATIVE_SodplannerPred(asn1SccSodplannerPred *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccSodplannerPred *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_ActionstatusEnum_UPER
int Encode_UPER_ActionstatusEnum(void *pBuffer, size_t iMaxBufferSize, const asn1SccActionstatusEnum *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccActionstatusEnum_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode ActionstatusEnum (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_ActionstatusEnum_ACN
int Encode_ACN_ActionstatusEnum(void *pBuffer, size_t iMaxBufferSize, asn1SccActionstatusEnum *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccActionstatusEnum_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode ActionstatusEnum (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_ActionstatusEnum_NATIVE
int Encode_NATIVE_ActionstatusEnum(void *pBuffer, size_t iMaxBufferSize, const asn1SccActionstatusEnum *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccActionstatusEnum) );
    return sizeof(asn1SccActionstatusEnum);
}
#endif

#ifdef __NEED_ActionstatusEnum_UPER
int Decode_UPER_ActionstatusEnum(asn1SccActionstatusEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccActionstatusEnum_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode ActionstatusEnum (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_ActionstatusEnum_ACN
int Decode_ACN_ActionstatusEnum(asn1SccActionstatusEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccActionstatusEnum_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_ActionstatusEnum_NATIVE
int Decode_NATIVE_ActionstatusEnum(asn1SccActionstatusEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccActionstatusEnum *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_StateidEnum_UPER
int Encode_UPER_StateidEnum(void *pBuffer, size_t iMaxBufferSize, const asn1SccStateidEnum *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccStateidEnum_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode StateidEnum (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_StateidEnum_ACN
int Encode_ACN_StateidEnum(void *pBuffer, size_t iMaxBufferSize, asn1SccStateidEnum *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccStateidEnum_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode StateidEnum (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_StateidEnum_NATIVE
int Encode_NATIVE_StateidEnum(void *pBuffer, size_t iMaxBufferSize, const asn1SccStateidEnum *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccStateidEnum) );
    return sizeof(asn1SccStateidEnum);
}
#endif

#ifdef __NEED_StateidEnum_UPER
int Decode_UPER_StateidEnum(asn1SccStateidEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccStateidEnum_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode StateidEnum (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_StateidEnum_ACN
int Decode_ACN_StateidEnum(asn1SccStateidEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccStateidEnum_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_StateidEnum_NATIVE
int Decode_NATIVE_StateidEnum(asn1SccStateidEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccStateidEnum *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_CommandstateEnum_UPER
int Encode_UPER_CommandstateEnum(void *pBuffer, size_t iMaxBufferSize, const asn1SccCommandstateEnum *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccCommandstateEnum_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode CommandstateEnum (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_CommandstateEnum_ACN
int Encode_ACN_CommandstateEnum(void *pBuffer, size_t iMaxBufferSize, asn1SccCommandstateEnum *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccCommandstateEnum_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode CommandstateEnum (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_CommandstateEnum_NATIVE
int Encode_NATIVE_CommandstateEnum(void *pBuffer, size_t iMaxBufferSize, const asn1SccCommandstateEnum *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccCommandstateEnum) );
    return sizeof(asn1SccCommandstateEnum);
}
#endif

#ifdef __NEED_CommandstateEnum_UPER
int Decode_UPER_CommandstateEnum(asn1SccCommandstateEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccCommandstateEnum_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode CommandstateEnum (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_CommandstateEnum_ACN
int Decode_ACN_CommandstateEnum(asn1SccCommandstateEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccCommandstateEnum_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_CommandstateEnum_NATIVE
int Decode_NATIVE_CommandstateEnum(asn1SccCommandstateEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccCommandstateEnum *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_YawidEnum_UPER
int Encode_UPER_YawidEnum(void *pBuffer, size_t iMaxBufferSize, const asn1SccYawidEnum *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccYawidEnum_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode YawidEnum (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_YawidEnum_ACN
int Encode_ACN_YawidEnum(void *pBuffer, size_t iMaxBufferSize, asn1SccYawidEnum *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccYawidEnum_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode YawidEnum (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_YawidEnum_NATIVE
int Encode_NATIVE_YawidEnum(void *pBuffer, size_t iMaxBufferSize, const asn1SccYawidEnum *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccYawidEnum) );
    return sizeof(asn1SccYawidEnum);
}
#endif

#ifdef __NEED_YawidEnum_UPER
int Decode_UPER_YawidEnum(asn1SccYawidEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccYawidEnum_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode YawidEnum (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_YawidEnum_ACN
int Decode_ACN_YawidEnum(asn1SccYawidEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccYawidEnum_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_YawidEnum_NATIVE
int Decode_NATIVE_YawidEnum(asn1SccYawidEnum *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccYawidEnum *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_Int3d_UPER
int Encode_UPER_Int3d(void *pBuffer, size_t iMaxBufferSize, const asn1SccInt3d *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccInt3d_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Int3d (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_Int3d_ACN
int Encode_ACN_Int3d(void *pBuffer, size_t iMaxBufferSize, asn1SccInt3d *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccInt3d_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Int3d (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_Int3d_NATIVE
int Encode_NATIVE_Int3d(void *pBuffer, size_t iMaxBufferSize, const asn1SccInt3d *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccInt3d) );
    return sizeof(asn1SccInt3d);
}
#endif

#ifdef __NEED_Int3d_UPER
int Decode_UPER_Int3d(asn1SccInt3d *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccInt3d_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode Int3d (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_Int3d_ACN
int Decode_ACN_Int3d(asn1SccInt3d *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccInt3d_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_Int3d_NATIVE
int Decode_NATIVE_Int3d(asn1SccInt3d *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccInt3d *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_Wmstatusstatus_UPER
int Encode_UPER_Wmstatusstatus(void *pBuffer, size_t iMaxBufferSize, const asn1SccWmstatusstatus *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccWmstatusstatus_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Wmstatusstatus (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_Wmstatusstatus_ACN
int Encode_ACN_Wmstatusstatus(void *pBuffer, size_t iMaxBufferSize, asn1SccWmstatusstatus *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccWmstatusstatus_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Wmstatusstatus (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_Wmstatusstatus_NATIVE
int Encode_NATIVE_Wmstatusstatus(void *pBuffer, size_t iMaxBufferSize, const asn1SccWmstatusstatus *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccWmstatusstatus) );
    return sizeof(asn1SccWmstatusstatus);
}
#endif

#ifdef __NEED_Wmstatusstatus_UPER
int Decode_UPER_Wmstatusstatus(asn1SccWmstatusstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccWmstatusstatus_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode Wmstatusstatus (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_Wmstatusstatus_ACN
int Decode_ACN_Wmstatusstatus(asn1SccWmstatusstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccWmstatusstatus_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_Wmstatusstatus_NATIVE
int Decode_NATIVE_Wmstatusstatus(asn1SccWmstatusstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccWmstatusstatus *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_Sodmissionstatus_UPER
int Encode_UPER_Sodmissionstatus(void *pBuffer, size_t iMaxBufferSize, const asn1SccSodmissionstatus *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccSodmissionstatus_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Sodmissionstatus (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_Sodmissionstatus_ACN
int Encode_ACN_Sodmissionstatus(void *pBuffer, size_t iMaxBufferSize, asn1SccSodmissionstatus *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccSodmissionstatus_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Sodmissionstatus (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_Sodmissionstatus_NATIVE
int Encode_NATIVE_Sodmissionstatus(void *pBuffer, size_t iMaxBufferSize, const asn1SccSodmissionstatus *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccSodmissionstatus) );
    return sizeof(asn1SccSodmissionstatus);
}
#endif

#ifdef __NEED_Sodmissionstatus_UPER
int Decode_UPER_Sodmissionstatus(asn1SccSodmissionstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccSodmissionstatus_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode Sodmissionstatus (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_Sodmissionstatus_ACN
int Decode_ACN_Sodmissionstatus(asn1SccSodmissionstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccSodmissionstatus_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_Sodmissionstatus_NATIVE
int Decode_NATIVE_Sodmissionstatus(asn1SccSodmissionstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccSodmissionstatus *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_Sodplannerstatus_UPER
int Encode_UPER_Sodplannerstatus(void *pBuffer, size_t iMaxBufferSize, const asn1SccSodplannerstatus *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccSodplannerstatus_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Sodplannerstatus (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_Sodplannerstatus_ACN
int Encode_ACN_Sodplannerstatus(void *pBuffer, size_t iMaxBufferSize, asn1SccSodplannerstatus *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccSodplannerstatus_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode Sodplannerstatus (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_Sodplannerstatus_NATIVE
int Encode_NATIVE_Sodplannerstatus(void *pBuffer, size_t iMaxBufferSize, const asn1SccSodplannerstatus *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccSodplannerstatus) );
    return sizeof(asn1SccSodplannerstatus);
}
#endif

#ifdef __NEED_Sodplannerstatus_UPER
int Decode_UPER_Sodplannerstatus(asn1SccSodplannerstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccSodplannerstatus_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode Sodplannerstatus (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_Sodplannerstatus_ACN
int Decode_ACN_Sodplannerstatus(asn1SccSodplannerstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccSodplannerstatus_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_Sodplannerstatus_NATIVE
int Decode_NATIVE_Sodplannerstatus(asn1SccSodplannerstatus *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccSodplannerstatus *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_1_Data_UPER
int Encode_UPER_PusTC_210_1_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_1_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_1_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-1-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_1_Data_ACN
int Encode_ACN_PusTC_210_1_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_1_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_1_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-1-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_1_Data_NATIVE
int Encode_NATIVE_PusTC_210_1_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_1_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_1_Data) );
    return sizeof(asn1SccPusTC_210_1_Data);
}
#endif

#ifdef __NEED_PusTC_210_1_Data_UPER
int Decode_UPER_PusTC_210_1_Data(asn1SccPusTC_210_1_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_1_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-1-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_1_Data_ACN
int Decode_ACN_PusTC_210_1_Data(asn1SccPusTC_210_1_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_1_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_1_Data_NATIVE
int Decode_NATIVE_PusTC_210_1_Data(asn1SccPusTC_210_1_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_1_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_2_Data_UPER
int Encode_UPER_PusTC_210_2_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_2_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_2_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-2-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_2_Data_ACN
int Encode_ACN_PusTC_210_2_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_2_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_2_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-2-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_2_Data_NATIVE
int Encode_NATIVE_PusTC_210_2_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_2_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_2_Data) );
    return sizeof(asn1SccPusTC_210_2_Data);
}
#endif

#ifdef __NEED_PusTC_210_2_Data_UPER
int Decode_UPER_PusTC_210_2_Data(asn1SccPusTC_210_2_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_2_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-2-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_2_Data_ACN
int Decode_ACN_PusTC_210_2_Data(asn1SccPusTC_210_2_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_2_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_2_Data_NATIVE
int Decode_NATIVE_PusTC_210_2_Data(asn1SccPusTC_210_2_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_2_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_11_Data_UPER
int Encode_UPER_PusTC_210_11_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_11_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_11_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-11-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_11_Data_ACN
int Encode_ACN_PusTC_210_11_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_11_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_11_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-11-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_11_Data_NATIVE
int Encode_NATIVE_PusTC_210_11_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_11_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_11_Data) );
    return sizeof(asn1SccPusTC_210_11_Data);
}
#endif

#ifdef __NEED_PusTC_210_11_Data_UPER
int Decode_UPER_PusTC_210_11_Data(asn1SccPusTC_210_11_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_11_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-11-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_11_Data_ACN
int Decode_ACN_PusTC_210_11_Data(asn1SccPusTC_210_11_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_11_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_11_Data_NATIVE
int Decode_NATIVE_PusTC_210_11_Data(asn1SccPusTC_210_11_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_11_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_12_Data_UPER
int Encode_UPER_PusTC_210_12_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_12_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_12_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-12-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_12_Data_ACN
int Encode_ACN_PusTC_210_12_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_12_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_12_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-12-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_12_Data_NATIVE
int Encode_NATIVE_PusTC_210_12_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_12_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_12_Data) );
    return sizeof(asn1SccPusTC_210_12_Data);
}
#endif

#ifdef __NEED_PusTC_210_12_Data_UPER
int Decode_UPER_PusTC_210_12_Data(asn1SccPusTC_210_12_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_12_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-12-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_12_Data_ACN
int Decode_ACN_PusTC_210_12_Data(asn1SccPusTC_210_12_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_12_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_12_Data_NATIVE
int Decode_NATIVE_PusTC_210_12_Data(asn1SccPusTC_210_12_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_12_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_21_Data_UPER
int Encode_UPER_PusTC_210_21_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_21_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_21_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-21-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_21_Data_ACN
int Encode_ACN_PusTC_210_21_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_21_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_21_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-21-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_21_Data_NATIVE
int Encode_NATIVE_PusTC_210_21_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_21_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_21_Data) );
    return sizeof(asn1SccPusTC_210_21_Data);
}
#endif

#ifdef __NEED_PusTC_210_21_Data_UPER
int Decode_UPER_PusTC_210_21_Data(asn1SccPusTC_210_21_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_21_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-21-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_21_Data_ACN
int Decode_ACN_PusTC_210_21_Data(asn1SccPusTC_210_21_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_21_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_21_Data_NATIVE
int Decode_NATIVE_PusTC_210_21_Data(asn1SccPusTC_210_21_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_21_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_22_Data_UPER
int Encode_UPER_PusTC_210_22_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_22_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_22_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-22-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_22_Data_ACN
int Encode_ACN_PusTC_210_22_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_22_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_22_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-22-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_22_Data_NATIVE
int Encode_NATIVE_PusTC_210_22_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_22_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_22_Data) );
    return sizeof(asn1SccPusTC_210_22_Data);
}
#endif

#ifdef __NEED_PusTC_210_22_Data_UPER
int Decode_UPER_PusTC_210_22_Data(asn1SccPusTC_210_22_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_22_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-22-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_22_Data_ACN
int Decode_ACN_PusTC_210_22_Data(asn1SccPusTC_210_22_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_22_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_22_Data_NATIVE
int Decode_NATIVE_PusTC_210_22_Data(asn1SccPusTC_210_22_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_22_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_23_Data_UPER
int Encode_UPER_PusTC_210_23_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_23_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_23_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-23-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_23_Data_ACN
int Encode_ACN_PusTC_210_23_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_23_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_23_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-23-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_23_Data_NATIVE
int Encode_NATIVE_PusTC_210_23_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_23_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_23_Data) );
    return sizeof(asn1SccPusTC_210_23_Data);
}
#endif

#ifdef __NEED_PusTC_210_23_Data_UPER
int Decode_UPER_PusTC_210_23_Data(asn1SccPusTC_210_23_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_23_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-23-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_23_Data_ACN
int Decode_ACN_PusTC_210_23_Data(asn1SccPusTC_210_23_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_23_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_23_Data_NATIVE
int Decode_NATIVE_PusTC_210_23_Data(asn1SccPusTC_210_23_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_23_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_24_Data_UPER
int Encode_UPER_PusTC_210_24_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_24_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_24_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-24-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_24_Data_ACN
int Encode_ACN_PusTC_210_24_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_24_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_24_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-24-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_24_Data_NATIVE
int Encode_NATIVE_PusTC_210_24_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_24_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_24_Data) );
    return sizeof(asn1SccPusTC_210_24_Data);
}
#endif

#ifdef __NEED_PusTC_210_24_Data_UPER
int Decode_UPER_PusTC_210_24_Data(asn1SccPusTC_210_24_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_24_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-24-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_24_Data_ACN
int Decode_ACN_PusTC_210_24_Data(asn1SccPusTC_210_24_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_24_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_24_Data_NATIVE
int Decode_NATIVE_PusTC_210_24_Data(asn1SccPusTC_210_24_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_24_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_25_Data_UPER
int Encode_UPER_PusTC_210_25_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_25_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_25_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-25-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_25_Data_ACN
int Encode_ACN_PusTC_210_25_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_25_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_25_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-25-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_25_Data_NATIVE
int Encode_NATIVE_PusTC_210_25_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_25_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_25_Data) );
    return sizeof(asn1SccPusTC_210_25_Data);
}
#endif

#ifdef __NEED_PusTC_210_25_Data_UPER
int Decode_UPER_PusTC_210_25_Data(asn1SccPusTC_210_25_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_25_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-25-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_25_Data_ACN
int Decode_ACN_PusTC_210_25_Data(asn1SccPusTC_210_25_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_25_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_25_Data_NATIVE
int Decode_NATIVE_PusTC_210_25_Data(asn1SccPusTC_210_25_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_25_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_26_Data_UPER
int Encode_UPER_PusTC_210_26_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_26_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_26_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-26-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_26_Data_ACN
int Encode_ACN_PusTC_210_26_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_26_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_26_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-26-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_26_Data_NATIVE
int Encode_NATIVE_PusTC_210_26_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_26_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_26_Data) );
    return sizeof(asn1SccPusTC_210_26_Data);
}
#endif

#ifdef __NEED_PusTC_210_26_Data_UPER
int Decode_UPER_PusTC_210_26_Data(asn1SccPusTC_210_26_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_26_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-26-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_26_Data_ACN
int Decode_ACN_PusTC_210_26_Data(asn1SccPusTC_210_26_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_26_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_26_Data_NATIVE
int Decode_NATIVE_PusTC_210_26_Data(asn1SccPusTC_210_26_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_26_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_27_Data_UPER
int Encode_UPER_PusTC_210_27_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_27_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_27_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-27-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_27_Data_ACN
int Encode_ACN_PusTC_210_27_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_27_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_27_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-27-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_27_Data_NATIVE
int Encode_NATIVE_PusTC_210_27_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_27_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_27_Data) );
    return sizeof(asn1SccPusTC_210_27_Data);
}
#endif

#ifdef __NEED_PusTC_210_27_Data_UPER
int Decode_UPER_PusTC_210_27_Data(asn1SccPusTC_210_27_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_27_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-27-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_27_Data_ACN
int Decode_ACN_PusTC_210_27_Data(asn1SccPusTC_210_27_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_27_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_27_Data_NATIVE
int Decode_NATIVE_PusTC_210_27_Data(asn1SccPusTC_210_27_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_27_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_28_Data_UPER
int Encode_UPER_PusTC_210_28_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_28_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_28_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-28-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_28_Data_ACN
int Encode_ACN_PusTC_210_28_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_28_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_28_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-28-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_28_Data_NATIVE
int Encode_NATIVE_PusTC_210_28_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_28_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_28_Data) );
    return sizeof(asn1SccPusTC_210_28_Data);
}
#endif

#ifdef __NEED_PusTC_210_28_Data_UPER
int Decode_UPER_PusTC_210_28_Data(asn1SccPusTC_210_28_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_28_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-28-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_28_Data_ACN
int Decode_ACN_PusTC_210_28_Data(asn1SccPusTC_210_28_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_28_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_28_Data_NATIVE
int Decode_NATIVE_PusTC_210_28_Data(asn1SccPusTC_210_28_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_28_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_29_Data_UPER
int Encode_UPER_PusTC_210_29_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_29_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_29_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-29-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_29_Data_ACN
int Encode_ACN_PusTC_210_29_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_29_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_29_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-29-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_29_Data_NATIVE
int Encode_NATIVE_PusTC_210_29_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_29_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_29_Data) );
    return sizeof(asn1SccPusTC_210_29_Data);
}
#endif

#ifdef __NEED_PusTC_210_29_Data_UPER
int Decode_UPER_PusTC_210_29_Data(asn1SccPusTC_210_29_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_29_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-29-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_29_Data_ACN
int Decode_ACN_PusTC_210_29_Data(asn1SccPusTC_210_29_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_29_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_29_Data_NATIVE
int Decode_NATIVE_PusTC_210_29_Data(asn1SccPusTC_210_29_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_29_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_30_Data_UPER
int Encode_UPER_PusTC_210_30_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_30_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_30_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-30-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_30_Data_ACN
int Encode_ACN_PusTC_210_30_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_30_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_30_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-30-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_30_Data_NATIVE
int Encode_NATIVE_PusTC_210_30_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_30_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_30_Data) );
    return sizeof(asn1SccPusTC_210_30_Data);
}
#endif

#ifdef __NEED_PusTC_210_30_Data_UPER
int Decode_UPER_PusTC_210_30_Data(asn1SccPusTC_210_30_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_30_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-30-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_30_Data_ACN
int Decode_ACN_PusTC_210_30_Data(asn1SccPusTC_210_30_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_30_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_30_Data_NATIVE
int Decode_NATIVE_PusTC_210_30_Data(asn1SccPusTC_210_30_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_30_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_31_Data_UPER
int Encode_UPER_PusTC_210_31_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_31_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_31_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-31-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_31_Data_ACN
int Encode_ACN_PusTC_210_31_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_31_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_31_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-31-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_31_Data_NATIVE
int Encode_NATIVE_PusTC_210_31_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_31_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_31_Data) );
    return sizeof(asn1SccPusTC_210_31_Data);
}
#endif

#ifdef __NEED_PusTC_210_31_Data_UPER
int Decode_UPER_PusTC_210_31_Data(asn1SccPusTC_210_31_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_31_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-31-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_31_Data_ACN
int Decode_ACN_PusTC_210_31_Data(asn1SccPusTC_210_31_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_31_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_31_Data_NATIVE
int Decode_NATIVE_PusTC_210_31_Data(asn1SccPusTC_210_31_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_31_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_32_Data_UPER
int Encode_UPER_PusTC_210_32_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_32_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_32_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-32-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_32_Data_ACN
int Encode_ACN_PusTC_210_32_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_32_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_32_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-32-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_32_Data_NATIVE
int Encode_NATIVE_PusTC_210_32_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_32_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_32_Data) );
    return sizeof(asn1SccPusTC_210_32_Data);
}
#endif

#ifdef __NEED_PusTC_210_32_Data_UPER
int Decode_UPER_PusTC_210_32_Data(asn1SccPusTC_210_32_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_32_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-32-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_32_Data_ACN
int Decode_ACN_PusTC_210_32_Data(asn1SccPusTC_210_32_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_32_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_32_Data_NATIVE
int Decode_NATIVE_PusTC_210_32_Data(asn1SccPusTC_210_32_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_32_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_41_Data_UPER
int Encode_UPER_PusTC_210_41_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_41_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_41_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-41-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_41_Data_ACN
int Encode_ACN_PusTC_210_41_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_41_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_41_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-41-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_41_Data_NATIVE
int Encode_NATIVE_PusTC_210_41_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_41_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_41_Data) );
    return sizeof(asn1SccPusTC_210_41_Data);
}
#endif

#ifdef __NEED_PusTC_210_41_Data_UPER
int Decode_UPER_PusTC_210_41_Data(asn1SccPusTC_210_41_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_41_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-41-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_41_Data_ACN
int Decode_ACN_PusTC_210_41_Data(asn1SccPusTC_210_41_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_41_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_41_Data_NATIVE
int Decode_NATIVE_PusTC_210_41_Data(asn1SccPusTC_210_41_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_41_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_42_Data_UPER
int Encode_UPER_PusTC_210_42_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_42_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_42_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-42-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_42_Data_ACN
int Encode_ACN_PusTC_210_42_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_42_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_42_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-42-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_42_Data_NATIVE
int Encode_NATIVE_PusTC_210_42_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_42_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_42_Data) );
    return sizeof(asn1SccPusTC_210_42_Data);
}
#endif

#ifdef __NEED_PusTC_210_42_Data_UPER
int Decode_UPER_PusTC_210_42_Data(asn1SccPusTC_210_42_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_42_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-42-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_42_Data_ACN
int Decode_ACN_PusTC_210_42_Data(asn1SccPusTC_210_42_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_42_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_42_Data_NATIVE
int Decode_NATIVE_PusTC_210_42_Data(asn1SccPusTC_210_42_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_42_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_61_Data_UPER
int Encode_UPER_PusTC_210_61_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_61_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_61_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-61-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_61_Data_ACN
int Encode_ACN_PusTC_210_61_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_61_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_61_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-61-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_61_Data_NATIVE
int Encode_NATIVE_PusTC_210_61_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_61_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_61_Data) );
    return sizeof(asn1SccPusTC_210_61_Data);
}
#endif

#ifdef __NEED_PusTC_210_61_Data_UPER
int Decode_UPER_PusTC_210_61_Data(asn1SccPusTC_210_61_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_61_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-61-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_61_Data_ACN
int Decode_ACN_PusTC_210_61_Data(asn1SccPusTC_210_61_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_61_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_61_Data_NATIVE
int Decode_NATIVE_PusTC_210_61_Data(asn1SccPusTC_210_61_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_61_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_62_Data_UPER
int Encode_UPER_PusTC_210_62_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_62_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_62_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-62-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_62_Data_ACN
int Encode_ACN_PusTC_210_62_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_62_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_62_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-62-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_62_Data_NATIVE
int Encode_NATIVE_PusTC_210_62_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_62_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_62_Data) );
    return sizeof(asn1SccPusTC_210_62_Data);
}
#endif

#ifdef __NEED_PusTC_210_62_Data_UPER
int Decode_UPER_PusTC_210_62_Data(asn1SccPusTC_210_62_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_62_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-62-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_62_Data_ACN
int Decode_ACN_PusTC_210_62_Data(asn1SccPusTC_210_62_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_62_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_62_Data_NATIVE
int Decode_NATIVE_PusTC_210_62_Data(asn1SccPusTC_210_62_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_62_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_63_Data_UPER
int Encode_UPER_PusTC_210_63_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_63_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_63_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-63-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_63_Data_ACN
int Encode_ACN_PusTC_210_63_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_63_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_63_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-63-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_63_Data_NATIVE
int Encode_NATIVE_PusTC_210_63_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_63_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_63_Data) );
    return sizeof(asn1SccPusTC_210_63_Data);
}
#endif

#ifdef __NEED_PusTC_210_63_Data_UPER
int Decode_UPER_PusTC_210_63_Data(asn1SccPusTC_210_63_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_63_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-63-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_63_Data_ACN
int Decode_ACN_PusTC_210_63_Data(asn1SccPusTC_210_63_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_63_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_63_Data_NATIVE
int Decode_NATIVE_PusTC_210_63_Data(asn1SccPusTC_210_63_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_63_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_64_Data_UPER
int Encode_UPER_PusTC_210_64_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_64_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_64_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-64-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_64_Data_ACN
int Encode_ACN_PusTC_210_64_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_64_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_64_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-64-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_64_Data_NATIVE
int Encode_NATIVE_PusTC_210_64_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_64_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_64_Data) );
    return sizeof(asn1SccPusTC_210_64_Data);
}
#endif

#ifdef __NEED_PusTC_210_64_Data_UPER
int Decode_UPER_PusTC_210_64_Data(asn1SccPusTC_210_64_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_64_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-64-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_64_Data_ACN
int Decode_ACN_PusTC_210_64_Data(asn1SccPusTC_210_64_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_64_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_64_Data_NATIVE
int Decode_NATIVE_PusTC_210_64_Data(asn1SccPusTC_210_64_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_64_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_65_Data_UPER
int Encode_UPER_PusTC_210_65_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_65_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_65_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-65-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_65_Data_ACN
int Encode_ACN_PusTC_210_65_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_65_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_65_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-65-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_65_Data_NATIVE
int Encode_NATIVE_PusTC_210_65_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_65_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_65_Data) );
    return sizeof(asn1SccPusTC_210_65_Data);
}
#endif

#ifdef __NEED_PusTC_210_65_Data_UPER
int Decode_UPER_PusTC_210_65_Data(asn1SccPusTC_210_65_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_65_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-65-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_65_Data_ACN
int Decode_ACN_PusTC_210_65_Data(asn1SccPusTC_210_65_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_65_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_65_Data_NATIVE
int Decode_NATIVE_PusTC_210_65_Data(asn1SccPusTC_210_65_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_65_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_66_Data_UPER
int Encode_UPER_PusTC_210_66_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_66_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_66_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-66-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_66_Data_ACN
int Encode_ACN_PusTC_210_66_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_66_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_66_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-66-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_66_Data_NATIVE
int Encode_NATIVE_PusTC_210_66_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_66_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_66_Data) );
    return sizeof(asn1SccPusTC_210_66_Data);
}
#endif

#ifdef __NEED_PusTC_210_66_Data_UPER
int Decode_UPER_PusTC_210_66_Data(asn1SccPusTC_210_66_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_66_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-66-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_66_Data_ACN
int Decode_ACN_PusTC_210_66_Data(asn1SccPusTC_210_66_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_66_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_66_Data_NATIVE
int Decode_NATIVE_PusTC_210_66_Data(asn1SccPusTC_210_66_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_66_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_71_Data_UPER
int Encode_UPER_PusTC_210_71_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_71_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_71_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-71-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_71_Data_ACN
int Encode_ACN_PusTC_210_71_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_71_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_71_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-71-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_71_Data_NATIVE
int Encode_NATIVE_PusTC_210_71_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_71_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_71_Data) );
    return sizeof(asn1SccPusTC_210_71_Data);
}
#endif

#ifdef __NEED_PusTC_210_71_Data_UPER
int Decode_UPER_PusTC_210_71_Data(asn1SccPusTC_210_71_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_71_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-71-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_71_Data_ACN
int Decode_ACN_PusTC_210_71_Data(asn1SccPusTC_210_71_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_71_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_71_Data_NATIVE
int Decode_NATIVE_PusTC_210_71_Data(asn1SccPusTC_210_71_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_71_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_72_Data_UPER
int Encode_UPER_PusTC_210_72_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_72_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_72_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-72-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_72_Data_ACN
int Encode_ACN_PusTC_210_72_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_72_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_72_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-72-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_72_Data_NATIVE
int Encode_NATIVE_PusTC_210_72_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_72_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_72_Data) );
    return sizeof(asn1SccPusTC_210_72_Data);
}
#endif

#ifdef __NEED_PusTC_210_72_Data_UPER
int Decode_UPER_PusTC_210_72_Data(asn1SccPusTC_210_72_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_72_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-72-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_72_Data_ACN
int Decode_ACN_PusTC_210_72_Data(asn1SccPusTC_210_72_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_72_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_72_Data_NATIVE
int Decode_NATIVE_PusTC_210_72_Data(asn1SccPusTC_210_72_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_72_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_73_Data_UPER
int Encode_UPER_PusTC_210_73_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_73_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_73_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-73-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_73_Data_ACN
int Encode_ACN_PusTC_210_73_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_73_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_73_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-73-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_73_Data_NATIVE
int Encode_NATIVE_PusTC_210_73_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_73_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_73_Data) );
    return sizeof(asn1SccPusTC_210_73_Data);
}
#endif

#ifdef __NEED_PusTC_210_73_Data_UPER
int Decode_UPER_PusTC_210_73_Data(asn1SccPusTC_210_73_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_73_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-73-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_73_Data_ACN
int Decode_ACN_PusTC_210_73_Data(asn1SccPusTC_210_73_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_73_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_73_Data_NATIVE
int Decode_NATIVE_PusTC_210_73_Data(asn1SccPusTC_210_73_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_73_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_81_Data_UPER
int Encode_UPER_PusTC_210_81_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_81_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_81_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-81-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_81_Data_ACN
int Encode_ACN_PusTC_210_81_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_81_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_81_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-81-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_81_Data_NATIVE
int Encode_NATIVE_PusTC_210_81_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_81_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_81_Data) );
    return sizeof(asn1SccPusTC_210_81_Data);
}
#endif

#ifdef __NEED_PusTC_210_81_Data_UPER
int Decode_UPER_PusTC_210_81_Data(asn1SccPusTC_210_81_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_81_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-81-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_81_Data_ACN
int Decode_ACN_PusTC_210_81_Data(asn1SccPusTC_210_81_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_81_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_81_Data_NATIVE
int Decode_NATIVE_PusTC_210_81_Data(asn1SccPusTC_210_81_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_81_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_82_Data_UPER
int Encode_UPER_PusTC_210_82_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_82_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_82_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-82-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_82_Data_ACN
int Encode_ACN_PusTC_210_82_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_82_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_82_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-82-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_82_Data_NATIVE
int Encode_NATIVE_PusTC_210_82_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_82_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_82_Data) );
    return sizeof(asn1SccPusTC_210_82_Data);
}
#endif

#ifdef __NEED_PusTC_210_82_Data_UPER
int Decode_UPER_PusTC_210_82_Data(asn1SccPusTC_210_82_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_82_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-82-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_82_Data_ACN
int Decode_ACN_PusTC_210_82_Data(asn1SccPusTC_210_82_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_82_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_82_Data_NATIVE
int Decode_NATIVE_PusTC_210_82_Data(asn1SccPusTC_210_82_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_82_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_91_Data_UPER
int Encode_UPER_PusTC_210_91_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_91_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_91_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-91-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_91_Data_ACN
int Encode_ACN_PusTC_210_91_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_91_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_91_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-91-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_91_Data_NATIVE
int Encode_NATIVE_PusTC_210_91_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_91_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_91_Data) );
    return sizeof(asn1SccPusTC_210_91_Data);
}
#endif

#ifdef __NEED_PusTC_210_91_Data_UPER
int Decode_UPER_PusTC_210_91_Data(asn1SccPusTC_210_91_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_91_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-91-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_91_Data_ACN
int Decode_ACN_PusTC_210_91_Data(asn1SccPusTC_210_91_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_91_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_91_Data_NATIVE
int Decode_NATIVE_PusTC_210_91_Data(asn1SccPusTC_210_91_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_91_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_92_Data_UPER
int Encode_UPER_PusTC_210_92_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_92_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_92_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-92-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_92_Data_ACN
int Encode_ACN_PusTC_210_92_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_92_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_92_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-92-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_92_Data_NATIVE
int Encode_NATIVE_PusTC_210_92_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_92_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_92_Data) );
    return sizeof(asn1SccPusTC_210_92_Data);
}
#endif

#ifdef __NEED_PusTC_210_92_Data_UPER
int Decode_UPER_PusTC_210_92_Data(asn1SccPusTC_210_92_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_92_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-92-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_92_Data_ACN
int Decode_ACN_PusTC_210_92_Data(asn1SccPusTC_210_92_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_92_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_92_Data_NATIVE
int Decode_NATIVE_PusTC_210_92_Data(asn1SccPusTC_210_92_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_92_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_93_Data_UPER
int Encode_UPER_PusTC_210_93_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_93_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_93_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-93-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_93_Data_ACN
int Encode_ACN_PusTC_210_93_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_93_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_93_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-93-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_93_Data_NATIVE
int Encode_NATIVE_PusTC_210_93_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_93_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_93_Data) );
    return sizeof(asn1SccPusTC_210_93_Data);
}
#endif

#ifdef __NEED_PusTC_210_93_Data_UPER
int Decode_UPER_PusTC_210_93_Data(asn1SccPusTC_210_93_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_93_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-93-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_93_Data_ACN
int Decode_ACN_PusTC_210_93_Data(asn1SccPusTC_210_93_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_93_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_93_Data_NATIVE
int Decode_NATIVE_PusTC_210_93_Data(asn1SccPusTC_210_93_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_93_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_94_Data_UPER
int Encode_UPER_PusTC_210_94_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_94_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_94_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-94-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_94_Data_ACN
int Encode_ACN_PusTC_210_94_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_94_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_94_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-94-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_94_Data_NATIVE
int Encode_NATIVE_PusTC_210_94_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_94_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_94_Data) );
    return sizeof(asn1SccPusTC_210_94_Data);
}
#endif

#ifdef __NEED_PusTC_210_94_Data_UPER
int Decode_UPER_PusTC_210_94_Data(asn1SccPusTC_210_94_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_94_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-94-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_94_Data_ACN
int Decode_ACN_PusTC_210_94_Data(asn1SccPusTC_210_94_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_94_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_94_Data_NATIVE
int Decode_NATIVE_PusTC_210_94_Data(asn1SccPusTC_210_94_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_94_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusTC_210_95_Data_UPER
int Encode_UPER_PusTC_210_95_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_95_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_95_Data_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-95-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusTC_210_95_Data_ACN
int Encode_ACN_PusTC_210_95_Data(void *pBuffer, size_t iMaxBufferSize, asn1SccPusTC_210_95_Data *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusTC_210_95_Data_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusTC-210-95-Data (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusTC_210_95_Data_NATIVE
int Encode_NATIVE_PusTC_210_95_Data(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusTC_210_95_Data *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusTC_210_95_Data) );
    return sizeof(asn1SccPusTC_210_95_Data);
}
#endif

#ifdef __NEED_PusTC_210_95_Data_UPER
int Decode_UPER_PusTC_210_95_Data(asn1SccPusTC_210_95_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_95_Data_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusTC-210-95-Data (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusTC_210_95_Data_ACN
int Decode_ACN_PusTC_210_95_Data(asn1SccPusTC_210_95_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusTC_210_95_Data_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusTC_210_95_Data_NATIVE
int Decode_NATIVE_PusTC_210_95_Data(asn1SccPusTC_210_95_Data *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusTC_210_95_Data *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusBoolean_UPER
int Encode_UPER_PusBoolean(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusBoolean *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusBoolean_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusBoolean (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusBoolean_ACN
int Encode_ACN_PusBoolean(void *pBuffer, size_t iMaxBufferSize, asn1SccPusBoolean *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusBoolean_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusBoolean (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusBoolean_NATIVE
int Encode_NATIVE_PusBoolean(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusBoolean *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusBoolean) );
    return sizeof(asn1SccPusBoolean);
}
#endif

#ifdef __NEED_PusBoolean_UPER
int Decode_UPER_PusBoolean(asn1SccPusBoolean *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusBoolean_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusBoolean (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusBoolean_ACN
int Decode_ACN_PusBoolean(asn1SccPusBoolean *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusBoolean_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusBoolean_NATIVE
int Decode_NATIVE_PusBoolean(asn1SccPusBoolean *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusBoolean *) pBuffer;
    {
        return 0;
    }
}
...
#ifdef __NEED_PusFloat32_UPER
int Encode_UPER_PusFloat32(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusFloat32 *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusFloat32_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusFloat32 (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    } else {
        return BitStream_GetLength(&strm);
...
#ifdef __NEED_PusFloat32_ACN
int Encode_ACN_PusFloat32(void *pBuffer, size_t iMaxBufferSize, asn1SccPusFloat32 *pSrc)
{
    (void)iMaxBufferSize;
    int errorCode;
    STATIC BitStream strm;
    ...
    BitStream_Init(&strm, pBuffer, iMaxBufferSize);
    if (asn1SccPusFloat32_ACN_Encode(pSrc, &strm, &errorCode, TRUE) == FALSE) {
#ifdef __unix__
	fprintf(stderr, "Could not encode PusFloat32 (at %s, %d), errorCode was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
...
#ifdef __NEED_PusFloat32_NATIVE
int Encode_NATIVE_PusFloat32(void *pBuffer, size_t iMaxBufferSize, const asn1SccPusFloat32 *pSrc)
{
    (void)iMaxBufferSize;
    memcpy(pBuffer, pSrc, sizeof(asn1SccPusFloat32) );
    return sizeof(asn1SccPusFloat32);
}
#endif

#ifdef __NEED_PusFloat32_UPER
int Decode_UPER_PusFloat32(asn1SccPusFloat32 *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusFloat32_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
	fprintf(stderr, "Could not decode PusFloat32 (at %s, %d), error code was %d\n", __FILE__, __LINE__, errorCode);
#endif
        return -1;
    }
}
...
#ifdef __NEED_PusFloat32_ACN
int Decode_ACN_PusFloat32(asn1SccPusFloat32 *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    int errorCode;
    ...
    if (asn1SccPusFloat32_ACN_Decode(pDst, &strm, &errorCode)) {
        /* Decoding succeeded */
        return 0;
    } else {
#ifdef __unix__
...
#ifdef __NEED_PusFloat32_NATIVE
int Decode_NATIVE_PusFloat32(asn1SccPusFloat32 *pDst, void *pBuffer, size_t iBufferSize)
{
    (void)iBufferSize;
    *pDst = *(asn1SccPusFloat32 *) pBuffer;
    {
        return 0;
    }
}
